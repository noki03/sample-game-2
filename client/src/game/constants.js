...
export const INITIAL_STATE = {
    ...
    units: [
        { id: 100, ownerId: 'self', x: 200, y: 200, type: 'builder', health: 100, maxHealth: 100, status: 'IDLE', stats: { speed: 5, range: 10, damage: 0 } }
    ],
    buildings: [
        { id: 500, ownerId: 'self', x: 100, y: 100, type: 'command_center', health: 2000, maxHealth: 2000, status: 'READY' },
        // --- Added Initial Barracks ---
        {
            id: 501,
            ownerId: 'self',
            x: 200,
            ...
            progress: 0,
            queue: [],
            rallyPoint: { x: 225, y: 180 } // Default rally point in front of the barracks
        },
        // ------------------------------
